...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(final HttpSecurity http) throws Exception {
        http.authorizeRequests().antMatchers("/login").permitAll().antMatchers("/tokens").permitAll().antMatchers("/")
                ...
                .antMatchers("/users/**").permitAll().antMatchers("/clients/**").permitAll().anyRequest().denyAll()
                .and().csrf().disable();
    }
