...
public class SwaggerConfig {
    ...
    private ApiInfo apiEndPointsInfo() {
        return new ApiInfoBuilder().title("Authorization Server").description("Authorization Server")
                .contact(new Contact("Catalin Patrut", "NO URL", "cpatrut@outlook.com")).license(APACHE_2_0)
